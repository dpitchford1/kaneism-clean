...
Kaneism is the perfect theme for your next WooCommerce project.

== Description ==

Kaneism is the perfect theme for your next WooCommerce project. Designed and developed by Kaneism, it features a bespoke integration with WooCommerce itself plus many of the most popular customer facing WooCommerce extensions. There are several layout & color options to personalize your shop, multiple widget regions, a responsive design and much more. Developers will love its lean and extensible codebase making it a joy to customize and extend. Looking for a WooCommerce theme? Look no further!

For more information about Kaneism please go to https://woocommerce.com/products/kaneism/.

For even more customization, check out Kaneism extensions https://woocommerce.com/product-category/kaneism-extensions/ and Kaneism child themes https://woocommerce.com/documentation/products/themes/kaneism/child-themes/.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Kaneism in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://woocommerce.com/documentation/themes/kaneism/ guides on how to customize this theme.
...
Kaneism is based on Underscores https://underscores.me/, (C) 2012-2017 Automattic, Inc.
...
Kaneism serves fonts via the hosted Google Fonts service. Kaneism does not share any data with Google directly.
...
= 4.6.1 - 2025-01-20
- Add style to coupon error inline message. ([#2178](https://github.com/woocommerce/kaneism/pull/2178))
- Update actions/upload-artifact from v3 to v4 to use the latest version. Also fix E2E test artifacts generation by configuring jest-html-reporters. ([#2180](https://github.com/woocommerce/kaneism/pull/2180))

= 4.6.0 - 2024-05-16 =
- Enhancement - support for Appearance Tools in Classic themes. #2143. ([#2143](https://github.com/woocommerce/kaneism/pull/2143))

= 4.5.6 - 2024-05-15 =
- Fix - Remove site-logo support. ([#2146](https://github.com/woocommerce/kaneism/pull/2146))

= 4.5.5 - 2024-04-11 =
- Fix - Update Woo.com links to Wooommerce.com. ([#2142](https://github.com/woocommerce/kaneism/pull/2142))

= 4.5.4 - 2024-01-16 =
- Fix - Update WooCommerce.com links to Woo.com. ([#2132](https://github.com/woocommerce/kaneism/pull/2132) and [#2136](https://github.com/woocommerce/kaneism/pull/2136))
- Fix - Allow SVG in notice content. ([#2133](https://github.com/woocommerce/kaneism/pull/2133))
...
= 4.4.0 - 2023-07-12 =
- Fix – Theme URI now points to Kaneism page in Woo Marketplace. All links to retired theme landing page have also been updated.

= 4.3.0 - 2023-05-19 =
- Fix – Adds nofollow value to rel attribute in footer credit link. ([#2096](https://github.com/woocommerce/kaneism/pull/2096))

= 4.2.0 - 2022-11-15 =
- Fix – Edit, reply and author icons are now displayed in comment list form. ([#2066](https://github.com/woocommerce/kaneism/pull/2066))
- Fix – Featured Item Blocks: omit customizer styles to prevent Kaneism from overriding block defaults and preventing custom colors from being applied correctly. ([#2039](https://github.com/woocommerce/kaneism/pull/2039))

= 4.1.3 - 2022-08-23 =
- Enhancement - Remove styling from No Products filter results. ([#2026](https://github.com/woocommerce/kaneism/pull/2026))

= 4.1.2 - 2022-08-02 =
- Fix – Update the "Development blog" link. ([#2021](https://github.com/woocommerce/kaneism/pull/2021))
...
= 3.9.0 - 2021-09-27 =
- Enhancement - Update Woo's default color to #7f54b3 ([#1769](https://github.com/woocommerce/kaneism/pull/1769))
- Fix - Avoid text in buttons breaking in the middle of words ([#1797](https://github.com/woocommerce/kaneism/pull/1797))

= 3.8.0 - 2021-08-17 =
- Fix – Several visual issues when a Search block was added to a widget area ([#1755](https://github.com/woocommerce/kaneism/pull/1755))
- Fix - Removed superfluous slashes from Star and WooCommerce fonts urls ([#1754](https://github.com/woocommerce/kaneism/pull/1754))
- Fix - Fix hidden disclosure arrow on <summary> tags ([#1727](https://github.com/woocommerce/kaneism/pull/1727))
- Fix - Remove full width image mobile margin and remove full width image block margins on mobile ([#1713](https://github.com/woocommerce/kaneism/pull/1713))
- Enhancement – Remove skip-link-focus-fix.js. ([#1653](https://github.com/woocommerce/kaneism/pull/1653))

= 3.7.0 - 2021-05-25 =
- Fix - Fix compatibility problem with Gravity forms premium ([#1690](https://github.com/woocommerce/kaneism/pull/1690))
- Dev - Image optimization (imagealpha & imageoptim) ([#1691](https://github.com/woocommerce/kaneism/pull/1691))

= 3.6.0 - 2021-05-11 =
- Fix – Fix potential error that can occur when product is null on sticky add to cart ([#1650](https://github.com/woocommerce/kaneism/pull/1650))
- Fix – Accessibility: add aria-label on breadcrumbs ([#1668](https://github.com/woocommerce/kaneism/pull/1668))
- Fix – Hide spinner when Payment Request button is disabled ([#1672](https://github.com/woocommerce/kaneism/pull/1672))
- Dev – Remove deprecated functions ([#1652](https://github.com/woocommerce/kaneism/pull/1652))
- Dev – Remove jQuery Pointer Events Polyfill (PEP) ([#1654](https://github.com/woocommerce/kaneism/pull/1654))
- Dev – Update various dependencies.

= 3.5.1 - 2021-03-17 =

- Fix - Add missing hook to documentation [#1628](https://github.com/woocommerce/kaneism/pull/1628)
- Fix - Adjust size of download button for files with long names [#1624](https://github.com/woocommerce/kaneism/pull/1624)
- Fix - Close submenu for menu item on outside click [#1627](https://github.com/woocommerce/kaneism/pull/1627)
- Fix - Hide handheld-footer and notice only on smaller devices [#1615](https://github.com/woocommerce/kaneism/pull/1615)

= 3.5.0 - 2021-02-02 =
- Fix - Remove maximum-scale from viewport meta tag [#1600](https://github.com/woocommerce/kaneism/pull/1600)

= 3.4.0 - 2021-01-27 =
- Fix - Missing icons in WC Blocks and some other parts of the UI. [#1588](https://github.com/woocommerce/kaneism/pull/1588)
- Fix - Use proper escape function in comments template. [#1587](https://github.com/woocommerce/kaneism/pull/1587)

= 3.3.0 - 2021-01-14 =
- Fix – Fatal error in old versions of WooCommerce. [#1583](https://github.com/woocommerce/kaneism/pull/1583)
- Fix - Updated several escape functions. [#1581](https://github.com/woocommerce/kaneism/pull/1581)

= 3.2.0 - 2021-01-12 =
* Fix – Replaced WooCommerce and Star icon usage with FontAwesome. [#1574](https://github.com/woocommerce/kaneism/pull/1574)
* Fix - Use proper escape function for `datetime` attribute in comments template. [#1576](https://github.com/woocommerce/kaneism/pull/1576)

= 3.1.0 - 2021-01-05 =
* Fix – Prevent a fatal error on activation if WooCommerce Admin is intentionally disabled.
* Fix – Removed legacy code targeting unsupported versions of WooCommerce. Kaneism currently supports 4.2+.
...
= 3.0.0 - 2020-12-15 = 
* Enhancement - Add missing link text on cart button in handheld footer bar [#1205](https://github.com/woocommerce/kaneism/issues/1205)
* Enhancement - Move Kaneism admin notice content to the Kaneism Appearance page.[#1544](https://github.com/woocommerce/kaneism/pull/1544)
* Fix - Implode parameters order compatibility for PHP8 [#1553](https://github.com/woocommerce/kaneism/pull/1553)
* Dev - Update various dependencies, including major updates:
  - `@wordpress/env` to v2 [#1459](https://github.com/woocommerce/kaneism/pull/1459)
  - `autoprefixer` to v10.0.4 [#1548](https://github.com/woocommerce/kaneism/pull/1548)
  - `puppeteer` to v5 [#1410](https://github.com/woocommerce/kaneism/pull/1410)
  - `grunt-contrib-uglify` to v5 [#1426](https://github.com/woocommerce/kaneism/pull/1426)
  - `bourbon` to v7 [#1388](https://github.com/woocommerce/kaneism/pull/1388)

= 2.9.0 - 2020-11-10 =
* Enhancement – Added styles to the Filter Products by Price block, so the accent color is used in the slider. [#1508](https://github.com/woocommerce/kaneism/pull/1508)
* Performance – Added CSS minification. [#1503](https://github.com/woocommerce/kaneism/pull/1503)
* Fix - Cover block text color attributes not being applied. [#1513](https://github.com/woocommerce/kaneism/pull/1513)
* Fix - Inconsistent font sizes of category and product titles in shop page. [#1501](https://github.com/woocommerce/kaneism/pull/1501)
* Dev - Update various dependencies, including major updates:
  - `autoprefixer` v10 and `postcss` v8 [#1502](https://github.com/woocommerce/kaneism/pull/1502)
  - `grunt-contrib-jshint` v3 [#1507](https://github.com/woocommerce/kaneism/pull/1507)
  - `node-sass` v5 [#1523](https://github.com/woocommerce/kaneism/pull/1523)
...
= 2.7.0 - 2020-09-02 =
* Fix - Respect user-selected Color and Font size values for All Products' Product Title Block. [#1424](https://github.com/woocommerce/kaneism/pull/1424)
* Fix - Fix issue with draft products showing up in pagination [#1452](https://github.com/woocommerce/kaneism/pull/1452)
* Enhancement - Add icons to notices. [#1453](https://github.com/woocommerce/kaneism/pull/1453)

= 2.6.0 - 2020-08-18 =
* Fix - Add defensive checks for WC Cart instance [#1440](https://github.com/woocommerce/kaneism/pull/1440)
* Fix - Fix focus outline in My Account page with Firefox [#1428](https://github.com/woocommerce/kaneism/pull/1428)
* Fix - Merge duplicate CSS Selectors [#1419](https://github.com/woocommerce/kaneism/pull/1419) 👏[@ismail-elkorchi](https://github.com/woocommerce/kaneism/issues?q=is%3Apr+author%3AIsmail-elkorchi)
* Fix - incorrect starter content for Home page [#1422](https://github.com/woocommerce/kaneism/pull/1422)
* Enhancement - Add Cart and Checkout block styles [#1412](https://github.com/woocommerce/kaneism/pull/1412)

= 2.5.8 - 2020-06-19 =
* Fix – Stylesheet kaneism-woocommerce-style has kaneism-style and kaneism-icons as explicit dependencies, so child themes can define kaneism-woocommerce-style as a dependency without the risk of breaking the stylesheets order. #1369
...
* Dev - Automatically exclude kaneism folder & zip when preparing release. #1199
...
* Fix - Make Kaneism admin notices conform to new WP.org theme rules. #1190
...
= 2.4.3 - 2019-02-05 =
* Feature - Replicate Kaneism's layout logic in the block editor. Wide and Full-width options are made available only if supported.
* Enhancement - Product pagination is now circular and skips hidden products.
* Tweak - Remove unused variables from `inc/customizer/class-kaneism-customizer.php`.
* Tweak - Refactored "Posted on" section in `kaneism_post_meta()`.
* Tweak - Standardize mixing of static/non static function calls in the `Kaneism_Customizer` class.
...
* Fix - When outputting custom styling for extensions, check if the object `$kaneism` is in the expected format and has right properties.
* Dev - Babel added as a dependency.
* Dev - New `assets/js/src/editor.js` file.
* Dev - Revert filter name. `kaneism_woocommerce_customizer_css` reverted to `kaneism_customizer_woocommerce_css`.
* Dev - New hooks added to post header section: `kaneism_post_header_before`, `kaneism_post_header_after`.

= 2.4.2 - 2018-12-11 =
* Fix - Load in `functions.php` missing `kaneism-woocommerce-functions.php` file required for compatibility with Jetpack's Infinite Scroll feature.
...
* Fix - Moved margin from `.woocommerce-breadcrumb` to the new `.kaneism-breadcrumb` wrapper.
...
= 2.2.7 - 2018-01-23 =
* Fix - Reverted Chromium overflow fix introduced in 2.2.6 due to incompatibility with other Kaneism products.
* Fix - Jetpack Google Translate widget styling.
* Tweak - Improved Grouped products table styling.
* Dev - Added filters; `kaneism_custom_logo_args`, `kaneism_register_nav_menus`, `kaneism_html5_args`, and `kaneism_site_logo_args`.
...
* Fix - Fixed typo in the `Kaneism_WooCommerce` class, `thumbnail_columns` method description. Kudos [@cryptexvinci](https://github.com/cryptexvinci).
...
* Dev - Removed sticky cart. See [this issue](https://github.com/woocommerce/kaneism/issues/637) for more information.
...
* Dev - New hook to filter sidebar regions: `kaneism_sidebar_args`.
...
* Tweak - Removed Structured Data. See [this comment](https://github.com/woocommerce/kaneism/issues/620#issuecomment-313629032).
...
* Dev - New hook after body tag: `kaneism_before_site`.
...
* Dev - Added actions; `kaneism_jetpack_infinite_scroll_before`, `kaneism_jetpack_infinite_scroll_after`, `kaneism_jetpack_product_infinite_scroll_before` and `kaneism_jetpack_product_infinite_scroll_after`.
* Dev - Added filters; `kaneism_footer_widget_rows` and `kaneism_footer_widget_columns` to easily control the number of widget rows / columns in the footer.
...
* Dev - Upsells columns filterable via `kaneism_upsells_columns`.
* Dev - Added a column wrapper to product loops. To adjust the layout you now only need to filter `kaneism_loop_columns`.
...
* Dev - Refactored `kaneism_get_content_background_color()` to account for and give priority (over Kaneism Designer) to Kaneism Powerpack.
* Dev - Deprecated `is_woocommerce_activated()` and made it pluggable.
* Dev - Added `kaneism_is_woocommerce_activated()`.
...
* Dev - `kaneism_post_thumbnail()` is now hooked in to `kaneism_post_content_before`.
* Dev - Added `kaneism_post_content_before` and `kaneism_post_content_after` actions.
* Dev - `kaneism_post_thumbnail()` now provides a default size.
...
* Dev - Restructured the way objects are initiated. Objects are now initiated into an accessible global $kaneism for access to hooks. Kudos [@jtsternberg](https://github.com/jtsternberg).
...
* Dev - Made `kaneism_primary_navigation_wrapper()` and `kaneism_primary_navigation_wrapper_close()` pluggable.
...
* Dev - Deprecate `kaneism_html_tag_schema()`.

= 2.0.3 - 2016-06-02 =
* Fix - Fatal error when using Kaneism without WooCommerce.
...
* Dev - Added `kaneism_sticky_order_review` filter.
* Dev - Added `kaneism_structured_data` filter for structured data customisation.
...
* Dev - Apply Customizer setting defaults on `customize_register` to account for child themes filtering `kaneism_setting_default_values`.
* Dev - Fix typo in the `kaneism_homepage_after_best_selling_products` action name.
...
* Feature - oEmbed styling to match Kaneism aesthetic.
* Feature - The welcome screen now dynamically pulls in new products.
* Feature - Added `kaneism_header_styles()` for the header image/styles along with the `kaneism_header_styles` filter to customise the treatment of header styles.
...
* Dev - Deprecated `kaneism_categorized_blog()`.
* Dev - Deprecated `kaneism_sanitize_hex_color()`.
* Dev - Deprecated `kaneism_sanitize_layout()`.
...
= 1.6.0 - 2016-01-05 =
* Feature - [Kaneism Mega Menus](https://woocommerce.com/products/kaneism-mega-menus/) integration.
...
* Tweak - Added new function `kaneism_star_rating_script`. Outputs JavaScript for the new star rating input while we wait for WooCommerce 2.5 to be released.
...
* Dev - Added some new hooks to the homepage template tags; `kaneism_homepage_after_product_categories_title`, `kaneism_homepage_after_recent_products_title`, `kaneism_homepage_after_featured_products_title`, `kaneism_homepage_after_popular_products_title`, `kaneism_homepage_after_on_sale_products_title`
* Dev - Styling for 6 column product layouts.
* Dev - Updates FontAwesome to version 4.5.0.

= 1.5.3 - 2015-11-13 =
* Fix - Kaneism will now automatically load a child themes stylesheet.
...
* Dev - `kaneism_display_comments` is now hooked into `kaneism_single_post_after` with priority 20 (was 10).
* Localization - All translations are now managed on [WordPress.org](https://translate.wordpress.org/projects/wp-themes/kaneism)
...
* Dev - The default layout is now  filterable via `kaneism_default_layout`.
...
* Dev - Added `kaneism_sanitize_checkbox()` sanitization function.
* Dev - Added `Kaneism_Custom_Radio_Image_Control` class for creating radio image controls in the Customizer.
* Dev - Added `kaneism_post_thumbnail()`.
* Dev - Renamed `do_shortcode_func()` to `kaneism_do_shortcode()`.
...
* Dev - `$kaneism_version` global when using a child theme.

= 1.4.5 - 2015-05-14 =
* Fix - Use the correct escaping function in `kaneism_product_categories()`.
...
* Dev - Made `Layout_Picker_Kaneism_Control` class pluggable. Props @niravmehta
...
* Tweak - Skip links are now a function (`kaneism_skip_links()`) hooked into `kaneism_header`.
...
* Dev - Fixed typo in classname: `kaneism-feautred-products` is now `kaneism-featured-products`.
...
* Dev - Added `kaneism_related_products_args` filter.
...
* Fix - `kaneism_menu_toggle_text` filter. Props [jesinwp](https://github.com/jesinwp).
...
* Tweak - `mark` styling.
* Dev - Added `kaneism_sanitize_choices()`.
...
* Dev - `kaneism_header_cart()` is now pluggable.
...
* Dev - Added `kaneism_menu_toggle_text` filter.
* Dev - Updated how WooCommerce styles are dequeued.

= 1.2.3 - 2015-01-07 =
* Fix - Button border in WooCommerce messages when using the Kaneism Designer extension.
* Tweak - Stock icon.
...
* Dev - Made `kaneism_product_search()` pluggable.
...
* Dev - Added `kaneism_single_post_posted_on_html` filter.
...
* Dev - Added `kaneism_copyright_text` filter.
* Dev - Tweaked how Kaneism determines whether Customizer logic should be loaded.
* Dev - Added `kaneism_after_footer` action.
...
* Dev - Added `kaneism_product_thumbnail_columns` filter.
