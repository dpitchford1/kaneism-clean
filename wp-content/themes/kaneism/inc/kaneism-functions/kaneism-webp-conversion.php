...
function kaneism_webp_admin_scripts( $hook ) {
	...
	// Enqueue CSS
	wp_enqueue_style( 'kaneism-webp-admin', get_template_directory_uri() . '/assets/css/webp-admin.css', array(), '1.0' );
	
	// Enqueue JavaScript
	wp_enqueue_script( 'kaneism-webp-admin', get_template_directory_uri() . '/assets/js/webp-admin.js', array( 'jquery' ), '1.0', true );
