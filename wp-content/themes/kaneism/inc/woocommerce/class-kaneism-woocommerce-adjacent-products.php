<?php
/**
 * Kaneism WooCommerce Adjacent Products Class
 *
 * @package  kaneism
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Kaneism_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Kaneism WooCommerce Adjacent Products Class
	 */
	class Kaneism_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'kaneism_woocommerce_adjacent_query_args', $args ) );
